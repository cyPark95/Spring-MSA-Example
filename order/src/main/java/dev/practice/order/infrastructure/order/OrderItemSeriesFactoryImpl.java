...
public class OrderItemSeriesFactoryImpl implements OrderItemSeriesFactory {
    ...
    public List<OrderItem> store(Order order, OrderCommand.RegisterOrder requestOrder) {
        return requestOrder.getOrderItems().stream()
                .map(orderItemRequest -> {
                    ...
                    orderItemRequest.getOrderItemOptionGroups().forEach(orderItemOptionGroupRequest -> {
                        ...
                        orderItemOptionGroupRequest.getOrderItemOptions().forEach(orderItemOptionRequest -> {
